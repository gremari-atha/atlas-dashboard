...
export function getTimeUnitSymbol(timeUnit: TimeUnit): string {
  if (timeUnit === "day") return "hari";
  if (timeUnit === "hour") return "jam";
  if (timeUnit === "minute") return "menit";
  if (timeUnit === "second") return "detik";
  return "ms";
}

export function formatDateIdStandard(
