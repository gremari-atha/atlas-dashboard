...
const navGroups = [
  {
    title: "Produk",
    items: [
      { title: "Produk", url: "/product", icon: Package },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Akun", url: "/account", icon: User },
    ],
  },
  {
    title: "Transaksi",
    items: [
      { title: "Transaksi", url: "/transaction", icon: Receipt },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Email Subject", url: "/email-subject", icon: Mail },
      { title: "Email Message", url: "/email-message", icon: Mails },
    ],
  },
];
